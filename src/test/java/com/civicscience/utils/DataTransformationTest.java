...
public class DataTransformationTest {
  ...
  String s =
      "h2 2022-11-30T00:11:29.309066Z app/web-PROD-ALB/05f72ee140d3036c 70.181.206.224:60561 172.18.2.48:80 "
          +
  ...
  public void testTransformUserAgent() {
    UserAgent ua = dt.transformUserAgent(
  ...
  public void mapToObjectTest() {
    ...
    Assert.assertEquals("3815", log.getTarget_id());
    Assert.assertEquals("628319436.1055353609", log.getId());
    Assert.assertFalse(log.isUa_is_bot());
  }
  ...
  public void dElementFieldExtractTest() {
    ...
    Assert.assertEquals("161557", map.get("askable"));
    Assert.assertEquals(true, map.get("isContainerSeen"));
  }
}
